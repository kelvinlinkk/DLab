...
## LED
set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { isBrdy_check }]; #IO_L18P_T2_A24_15 Sch=led[0]
# set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { toggle_check }]; #IO_L24P_T3_RS1_15 Sch=led[1]

##Switches

# set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { toggle_sw }]; #IO_L24N_T3_RS0_15 Sch=sw[0]
...
# set_property -dict { PACKAGE_PIN R17   IOSTANDARD LVCMOS33 } [get_ports { dp_in }]; #IO_L12N_T1_MRCC_14 Sch=sw[4]
